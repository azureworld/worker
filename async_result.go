...
func NewAsyncResult(signature *tasks.Signature, backend api.Backend) *AsyncResult {
	return &AsyncResult{
		Signature: signature,
...
func NewChordAsyncResult(groupTasks []*tasks.Signature, chordCallback *tasks.Signature, backend api.Backend) *ChordAsyncResult {
...
func NewChainAsyncResult(tasks []*tasks.Signature, backend api.Backend) *ChainAsyncResult {
